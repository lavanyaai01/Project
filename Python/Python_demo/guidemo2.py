...
clickbutton=Button(login,text="OK",command=output)
clickbutton.grid(row=3,column=40)
clickbutton1=Button(login,text="Cancel")
clickbutton1.grid(row=3,column=50,padx=40,pady=40)
labeltitle2=Label(login,text="Output")
labeltitle2.grid(row=4,column=10,padx=30,pady=30)
Entry3=Entry(login,width=50)
Entry3.grid(row=4,column=20)
login.mainloop ()